    			...
    			["embeds"] = {
    				{
    					...
    					["description"] = username .. " just hatched a Hardcore **" .. PetName .. "**! (**" .. chance .. "%**)",
    					["fields"] = {},
    					["author"] = {
    						["name"] = username,
    					...
    					["footer"] = {
    						["text"] = HatchAmountCounter .. " | " .. FooterRarity .. " Hardcore",
    					},
...
print('PSX Pet Hatcher Hardcore V3.0.0, Maintained and Updated by PetSimulatorXPlayer#5011')
